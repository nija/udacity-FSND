...
def create_movielist():
    ...
    movielist.append(MovieMetadata("Toy Story", \
        "I'm from Mattel. Well, I'm not really from Mattel, I'm actually from a smaller company \
        that was purchased by Mattel in a leveraged buyout.", \
        'http://ia.media-imdb.com/images/M/MV5BMTgwMjI4MzU5N15BMl5BanBnXkFtZTcwMTMyNTk3OA@@._V1_\
        SY317_CR12,0,214,317_AL_.jpg', \
        'https://www.youtube.com/watch?v=KYz2wyBy3kc'))
    movielist.append(MovieMetadata("Avatar", \
        "I was hoping for some kind of tactical plan that didn't involve martyrdom", \
        'http://ia.media-imdb.com/images/M/MV5BMTYwOTEwNjAzMl5BMl5BanBnXkFtZTcwODc5MTUwMw@@._V1_\
    ...
    movielist.append(MovieMetadata("The Princess Bride", \
        ...
        book my father used to read to me when I was sick, and I used to read it to your father. \
        And today I'm gonna read it to you.", \
        'http://ia.media-imdb.com/images/M/MV5BMTkzMDgyNjQwM15BMl5BanBnXkFtZTgwNTg2Mjc1MDE@._V1_SY\
        317_CR0,0,214,317_AL_.jpg', \
        'https://www.youtube.com/watch?v=GNvy61LOqY0'))
    movielist.append(MovieMetadata("Serenity", \
        "Shiny. Let's be bad guys.", \
        'http://ia.media-imdb.com/images/M/MV5BMTI0NTY1MzY4NV5BMl5BanBnXkFtZTcwNTczODAzMQ@@._V1_SY\
        317_CR0,0,214,317_AL_.jpg', \
        'https://www.youtube.com/watch?v=JY3u7bB7dZk'))
    movielist.append(MovieMetadata("The Wizard of Speed and Time", \
        "Miss Belair, if you feel compelled to grab part of my body and shake it before you can \
        even be friendly, you've got far worse problems than you think I have.", \
        'http://ia.media-imdb.com/images/M/MV5BODc3MzA3MDQyN15BMl5BanBnXkFtZTYwMzE2MTk5._V1_SX214_\
        AL_.jpg', \
        'https://www.youtube.com/watch?v=3ldOTw60Ozg'))
    movielist.append(MovieMetadata("Inside Out", \
        "Take her to the moon for me. Okay?", \
        'http://ia.media-imdb.com/images/M/MV5BOTgxMDQwMDk0OF5BMl5BanBnXkFtZTgwNjU5OTg2NDE@._V1_SX\
        214_AL_.jpg', \
