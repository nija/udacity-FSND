...
def create_movielist():
    """Function for testing lists - populates a list of movies with
    sample data"""
    movielist = []
    for x in range(5):
...
def test_object_str_output():
    ...
    a = MovieMetadata("Movie Title", "Movie comment", "http://box_art.png", \
        "http://youtube.url")
    print "test_object_str_output:\n"
    print "created a"
    print a
    assert a.__str__() == \
        "MovieMetadata object with state: title:Movie Title comment:Movie " \
        "comment poster_image_url:http://box_art.png " \
        "trailer_youtube_url:http://youtube.url"

def test_object_repr_output():
    """TODO: Need to figure out how to mock-up some number of digits regex
        for this test.
...
#   print "%s" % (a.__repr__())
#   assert a.__repr__() == \
        # "MovieMetadata 4325376592 < " \
        # "title:Movie Title " \
        # "comment:Movie comment " \
        # "poster_image_url:http://box_art.png " \
        # "trailer_youtube_url:http://youtube.url >"
    pass
